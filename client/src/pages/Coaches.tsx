...
import gallery2 from "@assets/DenisHylandCoaching_1772092148075.jpg";
import gallery3 from "@assets/17.11.25_IRL_MU21_MD-1_v_Andorra_Photo-101_1772196393925.jpg";
import gallery4 from "@assets/coaching1_1772196393925.jpg";
import gallery5 from "@assets/coaching2_1772196393925.jpg";
...
const galleryImages = [
  ...
  { src: gallery4, alt: "Coach on the training ground" },
  { src: gallery5, alt: "Coaching session in action" },
];
    ...
    <div className="bg-[#111316] text-white pt-20">
      ...
      <section className="py-24 bg-[#0e1014] relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 60% 50%, #9A0A0A 0%, transparent 60%)",
          }}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-heading text-6xl sm:text-7xl lg:text-8xl text-white uppercase tracking-wide leading-none mb-6">
            LEARN FROM
            <br />
            <span className="text-[#9A0A0A]">THE BEST</span>
          </h1>
          <p className="text-[#B9B2A5] text-xl max-w-2xl leading-relaxed">
            Our coaching team brings together UEFA Pro and UEFA A licensed
            coaches with decades of professional playing and coaching experience
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-[#9A0A0A] text-sm uppercase tracking-widest font-semibold mb-6">
                Head Coach & Academy Director
              </p>

              <p className="text-[#B9B2A5] leading-relaxed mb-4">
                Andy Reid is a former Republic of Ireland international
                midfielder and current academy coach at Premier League club
                Nottingham Forest. He enjoyed a successful professional career
                playing over 400 senior games, including spells with Nottingham
                Forest, Tottenham Hotspur, Charlton Athletic, Sunderland, and
                Blackpool. Andy earned 29 caps for Ireland, representing his
                country at senior international level for more than a decade.
                Since retiring, he has moved into elite coaching, helping
                develop the next generation of professional players.
              </p>
                ...
                {[
                  {
                    ...
                    label: "UEFA Pro Licence",
                  },
                  {
                    icon: <Trophy className="w-4 h-4" />,
                    label: "Former Premier League Player",
                  },
                  {
                    icon: <Shield className="w-4 h-4" />,
                    label: "Republic of Ireland International",
                  },
                  {
                    icon: <Award className="w-4 h-4" />,
                    label: "29 Senior International Caps",
                  },
                ].map((badge, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 bg-[#1a1e25] border border-white/10 rounded-md px-4 py-3"
                  >
                    <div className="text-[#9A0A0A]">{badge.icon}</div>
                    <span className="text-[#E2E2E1] text-xs font-medium">
                      {badge.label}
                    </span>
                  </div>
                ))}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="lg:order-1">
              ...
              <p className="text-[#B9B2A5] leading-relaxed mb-8">
                Denis Hyland is a UEFA Pro Licensed coach with over 20 years'
                experience developing elite youth and international players. As
                founder of the TY programme, he has guided numerous players to
                professional contracts and senior international football. For
                the past 15 years, he has also served as a national team coach
                with Ireland's U16, U18, and U21 squads.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-[#B9B2A5] text-lg max-w-2xl mx-auto">
              The same elite-level coaching your son will receive.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#9A0A0A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 text-lg mb-8">
            Apply now to learn from UEFA Pro licensed coaches with proven
