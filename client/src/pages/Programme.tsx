...
import programmeBgImg from "@assets/ProgrammPageTitleBackground_1772064267097.jpeg";
import whyChooseUsImg from "@assets/ProgrammePageWhyChooseUsTrainingSession_1772064267097.jpeg";
    ...
    <div className="bg-[#111316] text-white pt-20">
      ...
      <section className="relative py-24 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${programmeBgImg})` }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#111316]/80 via-[#111316]/60 to-[#0e1014]" />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-heading text-6xl sm:text-7xl lg:text-8xl text-white uppercase tracking-wide leading-none mb-6">
            ANDY REID<br /><span className="text-[#9A0A0A]">TY PROGRAMME</span>
          </h1>
      ...
      <section className="py-20 bg-[#111316]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-[#B9B2A5] text-base leading-relaxed mb-6">
            ...
            <p className="text-[#B9B2A5] text-base leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: "Programme Length", value: "9 Months" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Elite Coaching Staff", desc: "Our elite coaching staff hold UEFA Pro licenses. Every session is planned and delivered with professional precision." },
